...
public enum ReviewExceptionType implements ExceptionType {
    ...
    REVIEW_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "이 상품에 대한 리뷰가 존재하지 않습니다."),
    AUTHORITY_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "이 상품에 대한 리뷰를 삭제 할 권한이 없습니다.");
